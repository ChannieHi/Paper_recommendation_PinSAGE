...
def assign_textual_node_features(ndata, textset, ntype):
    ...
    for field_name, field in textset.fields.items():
        ...
        # Check if examples list is not empty before processing
        if examples:
            ...
            # Handle the case when examples list is empty
            print(f"Warning: Empty examples list for field {field_name}")
